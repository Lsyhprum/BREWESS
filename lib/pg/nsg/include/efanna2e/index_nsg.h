...
namespace efanna2e
{
    ...
    public:
        ...
        // virtual void LoadCentroids(const char *filename) override;

        virtual void Build(size_t n, const float *data, const Parameters &parameters) override;

        virtual void BatchSearchWithCodes(
            const float *luts,
        ...
        void SearchWithOptGraph(
            ...
            int *indices);
        void SearchWithOptGraph(
            const float *origin_base,
            const float *origin_query, 
            const float *query, 
            unsigned origin_dim,
            size_t K, 
            const Parameters &parameters, 
    ...
    protected:
        ...
        void compute_distance_tables(const float* x, float* dis_tables);
        unsigned eval_recall(std::vector<Neighbor>& g, const int *v, unsigned K);
