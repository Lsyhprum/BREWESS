...
def transpose(module1: nn.Module, 
    ...
    parametrize.register_parametrization(module2, name, _Transpose(module1), unsafe=True)

    return module2


class _Orthogonal(nn.Module):
    base: Tensor
...
# def orthogonal(weight: nn.Parameter,
#                orthogonal_map: Optional[str] = None,
#                *,
#                use_trivialization: bool = True) -> nn.Parameter:
